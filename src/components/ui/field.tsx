...
function Field({
  ...
  return (
    // biome-ignore lint/a11y/useSemanticElements: generic grouping primitive — role="group" stays semantically neutral without forcing fieldset/legend styling resets.
    <div
      role="group"
      data-slot="field"
